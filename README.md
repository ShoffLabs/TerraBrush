...
|FoliageResource[x].Definition.GrassShading|Apply vertical shading to the mesh albedo. Set to a small, positive value. A good starting point would be (0.18, 0.20, 0.18).|
